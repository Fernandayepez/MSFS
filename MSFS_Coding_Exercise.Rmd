...
summary(performance)
```
Since intercept is statistically significant, there is strong evidence that Q4 underperformance has a significantly positive chance of Q1 outperformance. Similarly, since beta_Q4 statistically significant there is here is strong evidence that Q4 outperformance reduces the likelihood of Q1 outperformance. 
...
Stocks that underperformed in Q4 2024 are much more likely to outperform in Q1 2025. Stocks that outperformed in Q4 2024 are roughly equally likely to outperform or underperform in Q1 2025. This suggests a mean-reverting pattern among Q4 underperformers but no strong momentum effect among Q4 outperformers
